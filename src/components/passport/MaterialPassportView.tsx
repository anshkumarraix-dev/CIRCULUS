...
export const MaterialPassportView: React.FC<MaterialPassportViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        {onBackToList && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-2xl bg-[#12181F] hover:bg-slate-50 border border-slate-700 text-xs font-bold text-slate-400 transition cursor-pointer shadow-xs"
          >
        ...
        <div className="flex items-center gap-2.5 ml-auto">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-2xl bg-[#12181F] hover:bg-slate-50 border border-slate-700 text-xs font-bold text-slate-300 transition cursor-pointer shadow-xs"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-2xl bg-[#12181F] hover:bg-slate-50 border border-emerald-300 text-xs font-bold text-emerald-800 transition cursor-pointer shadow-xs"
          >
      ...
      <div className="bg-[#12181F] rounded-3xl border border-slate-700 overflow-hidden shadow-xs">
        
        {/* ID Card Header */}
        <div className="bg-gradient-to-r from-[#1E2630] via-[#12181F] to-[#1E2630] px-6 sm:px-8 py-6 border-b border-slate-700 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-lg bg-slate-800 text-slate-300 border border-slate-700 font-mono">
        ...
        <div className="px-6 sm:px-8 py-4 bg-[#12181F] border-b border-slate-700">
            ...
            {simpleSteps.map((step) => (
              <div
                ...
                className={`p-3 rounded-2xl border text-xs transition ${
                  step.done
                    ? "bg-[#1E2630] border-blue-500/30 text-white shadow-xs"
                    : "bg-[#0B0F13] border-slate-800 text-slate-500"
                }`}
              >
                <div className="flex items-center gap-1.5 font-bold mb-1">
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] ${
                    step.done ? "bg-blue-600 text-white" : "bg-slate-800 text-slate-400"
                  }`}>
                    {step.num}
                  </span>
                  <span className={step.done ? "text-blue-400" : "text-slate-500"}>{step.title}</span>
                </div>
        ...
        <div className="p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 bg-[#0B0F13]">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="aspect-square w-full rounded-2xl overflow-hidden border border-slate-700 relative bg-[#12181F] shadow-xs">
              <img
                src={passport.imageUrl}
                alt={passport.materialType}
                className="w-full h-full object-cover"
              />
              <div className="absolute top-3 left-3 bg-[#12181F]/95 backdrop-blur-md px-3 py-1 rounded-xl text-xs font-bold text-slate-200 border border-slate-700 shadow-xs">
            ...
            {/* Scannable Bale Tag */}
            {qrCodeUrl && (
              <div className="bg-[#12181F] p-4 rounded-2xl border border-slate-700 flex items-center gap-3.5">
                <img src={qrCodeUrl} alt="Passport QR" className="w-18 h-18 rounded-xl border border-slate-700 p-1 bg-[#12181F] shrink-0" />
                <div className="text-xs">
                  <p className="font-extrabold text-white">Scannable QR Tag</p>
          ...
          <div className="lg:col-span-8 space-y-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="bg-[#12181F] p-4 rounded-2xl border border-slate-700">
                <span className="text-[11px] text-slate-400 font-bold uppercase block">Cleanliness Score</span>
              ...
              <div className="bg-[#12181F] p-4 rounded-2xl border border-slate-700">
                <span className="text-[11px] text-slate-400 font-bold uppercase block">Total Weight</span>
                <p className="text-2xl font-extrabold text-white font-mono mt-1">{passport.quantityMT} Tons</p>
                <p className="text-[11px] text-slate-500 mt-0.5">{passport.quantityMT * 1000} Kilograms</p>
              </div>

              <div className="bg-[#12181F] p-4 rounded-2xl border border-slate-700">
                <span className="text-[11px] text-slate-400 font-bold uppercase block flex items-center gap-1">
            ...
            <div className="bg-[#1E2630] p-5 rounded-2xl border border-slate-700 space-y-2.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                <div className="bg-[#0B0F13] p-3 rounded-xl border border-slate-700">
                  <span className="text-[10px] text-slate-500 uppercase font-bold block">Current Owner</span>
                  <p className="font-extrabold text-white mt-0.5 truncate">{passport.ownerOrg}</p>
                  <p className="text-[10px] text-slate-400 font-mono mt-0.5">GST: {passport.ownerGstin}</p>
                </div>

                <div className="bg-[#0B0F13] p-3 rounded-xl border border-slate-700">
                  <span className="text-[10px] text-slate-500 uppercase font-bold block">Factory City & State</span>
                  <p className="font-extrabold text-white mt-0.5 truncate">{passport.locationCity}</p>
                  <p className="text-[10px] text-slate-400 mt-0.5">{passport.locationState}, India</p>
                </div>

                <div className="bg-[#0B0F13] p-3 rounded-xl border border-slate-700">
                  <span className="text-[10px] text-slate-500 uppercase font-bold block">Local Authority</span>
                  <p className="font-extrabold text-blue-400 mt-0.5 truncate">{passport.spcbJurisdiction}</p>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {passport.suggestedApplications.map((app, i) => (
                  <div key={i} className="text-xs text-white flex items-center gap-2 bg-[#00E676]/10 p-3 rounded-xl border border-[#00E676]/30 font-medium">
            ...
            {/* Simple Green Fact */}
            <div className="bg-[#00E676]/10 p-4 rounded-2xl border border-[#00E676]/30 text-xs text-white space-y-1">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full p-3 rounded-2xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold transition flex items-center justify-between cursor-pointer border border-slate-700"
              >
              ...
              {showAdvancedTech && (
                <div className="mt-2 p-4 bg-[#1E2630] rounded-2xl border border-slate-700 space-y-2 text-xs font-mono animate-fadeIn">
                  <div>
                    <span className="text-[10px] text-slate-500 font-bold uppercase">SHA-256 Unique Proof Hash</span>
                    <div className="flex items-center justify-between bg-[#0B0F13] p-2 rounded-lg border border-slate-700 mt-1">
                      <span className="text-[11px] text-slate-400 truncate">{passport.recordHash}</span>
                      <button onClick={copyHashToClipboard} className="text-blue-400 text-[10px] font-bold ml-2 cursor-pointer">
                  ...
                  {passport.ledgerTxHash && (
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400 bg-[#0B0F13] p-2 rounded-lg border border-slate-700 mt-1 truncate">
                        {passport.ledgerTxHash}
                      </p>
                    </div>
                  )}
      ...
      <div className="bg-[#12181F] rounded-3xl border border-slate-700 p-6 sm:p-8 space-y-4 shadow-xs">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-xs font-bold text-white transition cursor-pointer shadow-xs"
          >
            + Transfer to Buyer
          </button>
        </div>

        <div className="relative pl-6 space-y-4 before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-blue-500/20">
          {events.length > 0 ? (
            events.map((ev) => (
              <div key={ev.id} className="relative">
                <div className="absolute -left-6 top-1.5 w-3 h-3 rounded-full bg-blue-500 border-2 border-[#12181F] shadow-xs"></div>
                <div className="bg-[#1E2630] p-4 rounded-2xl border border-slate-700 text-xs space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="font-extrabold text-white">{ev.eventType.replace(/_/g, " ")}</span>
                  ...
                  <p className="text-[11px] text-slate-500 pt-0.5">
                    By: <strong className="text-slate-400">{ev.actor}</strong> ({ev.location})
                  </p>
                </div>
              </div>
            ))
            ...
            <div className="relative">
              <div className="absolute -left-6 top-1.5 w-3 h-3 rounded-full bg-blue-500 border-2 border-[#12181F]"></div>
              <div className="bg-[#1E2630] p-4 rounded-2xl border border-slate-700 text-xs">
                <p className="font-bold text-white">ID CARD CREATED</p>
                <p className="text-slate-400 mt-1">{passport.notes || "Material batch recorded and verified."}</p>
      ...
      {showQrModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#12181F] rounded-3xl border border-slate-700 p-6 sm:p-7 max-w-lg w-full space-y-5 shadow-2xl animate-fadeIn my-6">
            
            {/* Modal Header */}
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
                <span className="text-xs font-extrabold text-white uppercase tracking-tight font-display">
                  Digital Aadhaar QR • Direct Scrap Data
                </span>
              </div>
              <button
                onClick={() => setShowQrModal(false)}
                className="text-slate-400 hover:text-slate-400 text-xs cursor-pointer font-bold px-2 py-1 rounded-lg hover:bg-slate-100 transition"
              >
                ✕ Close
              </button>
            </div>
            ...
            {/* QR Code Canvas */}
            <div className="bg-slate-50 p-4 rounded-3xl border border-slate-700 text-center">
              <div className="bg-[#12181F] p-3 rounded-2xl inline-block shadow-md mx-auto border border-slate-700">
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-700 space-y-2 text-xs">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-white text-right truncate max-w-[240px]">{passport.title}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-500 font-semibold">Weight / Quantity:</span>
                <span className="font-bold text-white">{passport.quantityMT} Tons ({passport.quantityMT * 1000} kg)</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-white truncate max-w-[240px]">{passport.ownerOrg}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-500 font-semibold">Origin GSTIN:</span>
                <span className="font-mono text-slate-300">{passport.ownerGstin}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-500 font-semibold">SPCB Jurisdiction:</span>
                <span className="text-slate-400">{passport.spcbJurisdiction}</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2.5 pt-1">
              <button
                ...
                className="py-2.5 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-700 text-xs font-bold text-slate-300 transition flex items-center justify-center gap-1.5 cursor-pointer"
              >
