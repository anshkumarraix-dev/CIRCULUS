          ...
          <div className="bg-slate-900/80 backdrop-blur-md p-1.5 rounded-2xl border border-white/20 flex items-center gap-1 shrink-0">
            <button
              ...
              className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${
                blockchainMode === "mock"
                  ? "bg-white text-emerald-950 shadow-xs border border-white/40"
            ...
            {events.length > 0 ? (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2.5 opacity-40 select-none pointer-events-none">
                  <div className="bg-slate-50 p-4 rounded-2xl border border-dashed border-slate-300 space-y-2 text-xs">
                    ...
                    <p className="text-slate-600 text-xs">Sample: Transferred 25.0 MT Aluminium 6063 Scrap to Recycler Plant</p>
                  ...
                  <div className="bg-slate-50 p-4 rounded-2xl border border-dashed border-slate-300 space-y-2 text-xs">
                    ...
                    <p className="text-slate-600 text-xs">Sample: 100% recycled into secondary extrusion billets. 230 t CO₂ avoided.</p>
                    <div className="flex justify-between text-[11px] text-slate-500 pt-1 border-t border-slate-200">
