      ...
      <div className="relative rounded-3xl overflow-hidden p-6 sm:p-8 border border-emerald-200 bg-gradient-to-r from-emerald-950 via-teal-900 to-slate-900 text-white shadow-md">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="bg-slate-900/80 backdrop-blur-md p-4 rounded-2xl border border-white/20 text-right min-w-[210px] shadow-xs">
            <span className="text-xs uppercase font-bold text-emerald-300 block">INSPECTION FACILITY</span>
            <p className="text-base font-bold text-white truncate mt-0.5">{activeRole.orgName}</p>
            <p className="text-sm text-slate-300">{activeRole.location}</p>
            <div className="mt-2 pt-2 border-t border-white/10 flex items-center justify-end gap-1 text-sm font-bold text-emerald-400">
            ...
            <React.Fragment key={s.step}>
              ...
              >
                ...
                <div className="min-w-0">
                  <p className={`text-sm font-bold truncate ${s.isActive ? "text-emerald-950" : s.isCompleted ? "text-white" : "text-slate-500"}`}>
                    {s.title}
                  </p>
                  <p className={`text-sm truncate ${s.isActive ? "text-emerald-700 font-semibold" : s.isCompleted ? "text-emerald-800" : "text-slate-400"}`}>
                    {s.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="bg-slate-950 p-6 rounded-3xl border border-slate-800 shadow-xl space-y-4 text-white">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-sm font-bold text-slate-300 flex items-center gap-1.5 transition cursor-pointer"
              >
              ...
              <button
                onClick={stopCamera}
                className="px-3 py-1.5 rounded-xl bg-red-950 text-red-300 hover:bg-red-900 text-sm font-bold flex items-center gap-1.5 transition cursor-pointer"
              >
          ...
          {cameraError ? (
            <div className="bg-slate-900 p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-slate-800 text-center space-y-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-accent-cyan text-primary text-white font-bold text-sm cursor-pointer"
              >
          ...
          <div className="flex items-center justify-center pt-2">
            <button
              ...
              className="px-8 py-4 rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 disabled:opacity-50 text-white font-extrabold text-base shadow-xl shadow-emerald-600/40 flex items-center gap-3 transition-all transform hover:scale-105 cursor-pointer border border-white/20"
            >
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-[#12181F] p-6 rounded-3xl border border-slate-700 shadow-xs space-y-4">
            <h3 className="text-base font-extrabold text-white flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-accent-cyan text-primary text-white flex items-center justify-center text-sm">2</span>
            ...
            <div className="space-y-3.5 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-600 rounded-xl px-3 py-2 text-sm text-white focus:bg-[#12181F] focus:border-blue-500 focus:outline-none font-medium"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-600 rounded-xl px-3 py-2 text-sm text-white focus:bg-[#12181F] focus:border-blue-500 focus:outline-none font-mono"
                  />
                </div>
                <div>
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50 text-white font-extrabold text-sm transition cursor-pointer flex items-center justify-center gap-2 shadow-lg shadow-blue-600/25 mt-2"
              >
                {isAnalyzing ? (
                  <>
          ...
          <div className="bg-[#12181F] p-6 sm:p-8 rounded-3xl border border-slate-700 shadow-xs h-full flex flex-col justify-between space-y-5">
            <div>
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <h3 className="text-base font-extrabold text-white flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-accent-cyan text-primary text-white flex items-center justify-center text-sm">3</span>
                  Certified AI Inspection Report
                </h3>
                {analysisResult && (
                  <span className={`text-sm font-bold px-3 py-1 rounded-xl border flex items-center gap-1.5 ${
              ...
              {analysisResult ? (
                <div className="space-y-4 mt-4 animate-fadeIn text-sm">
                  {/* Category Pill + Big Headline */}
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider">Identified Material</span>
                      {analysisResult.indiaMetadata?.materialCategory && (
                        <span className="text-xs font-bold px-2 py-0.5 rounded-md bg-accent-cyan/20 text-accent-cyan uppercase">
                          {analysisResult.indiaMetadata.materialCategory}
                        </span>
                      )}
                    </div>
                    ...
                    <p className="text-sm text-blue-700 font-bold mt-0.5 flex items-center gap-2">
                  ...
                  {analysisResult.confidence < 45 && (
                    <div className="bg-[#FF6D00]/10 p-4 rounded-2xl border border-[#FF6D00]/30 text-white space-y-3">
                      <div className="flex items-center gap-2 font-bold text-sm text-[#FF6D00]">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#FF6D00] hover:bg-[#E65C00] text-white rounded-xl text-sm font-bold transition flex items-center gap-2 shadow-lg shadow-[#FF6D00]/20"
                      >
                        <Camera className="w-4 h-4" />
                        Retake Photo Now
                      </button>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div className="bg-[#1E2630] p-3.5 rounded-2xl border border-slate-700">
                      <span className="text-xs text-slate-400 font-bold uppercase block">Purity & Cleanliness</span>
                      <p className="text-xl font-extrabold text-[#00E676] font-mono mt-1">
                        {analysisResult.reusabilityScore} / 100
                      </p>
                      <p className="text-xs text-slate-500 mt-0.5">Contamination: {analysisResult.contaminationRisk}</p>
                    </div>

                    <div className="bg-[#1E2630] p-3.5 rounded-2xl border border-slate-700">
                      <span className="text-xs text-slate-400 font-bold uppercase block">Avoided Carbon Emissions</span>
                      <p className="text-xl font-extrabold text-[#00E676] font-mono mt-1">
                        {(analysisResult.carbonImpact.reuseAvoidanceKgCO2e / 1000).toFixed(1)} MT
                      </p>
                      <p className="text-xs text-slate-500 mt-0.5">{analysisResult.carbonImpact.reuseAvoidanceKgCO2e.toLocaleString("en-IN")} kg CO₂e saved</p>
                    </div>

                    <div className="bg-[#1E2630] p-3.5 rounded-2xl border border-slate-700">
                      <span className="text-xs text-slate-400 font-bold uppercase block">Estimated Lot Value</span>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">For {quantityMT} MT batch</p>
                    </div>
                  </div>

                  {/* Secondary Circular Applications */}
                  <div className="bg-accent-cyan/5 p-4 rounded-2xl border border-accent-cyan/20 space-y-1.5">
                    <p className="font-extrabold text-sm text-accent-cyan flex items-center gap-1.5">
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pt-1">
                      {analysisResult.suggestedApplications.map((app, i) => (
                        <li key={i} className="text-sm text-slate-300 flex items-center gap-1.5 bg-[#12181F] p-2.5 rounded-xl border border-accent-cyan/20 font-medium">
                  ...
                  <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 sm:p-5 rounded-2xl border border-slate-800 text-white space-y-3 shadow-md">
                    <div className="flex flex-wrap items-center justify-between gap-2 pb-2.5 border-b border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <span className="text-sm font-extrabold text-white">Live Market & SPCB Grounding</span>
                            <span className="text-xs font-bold px-2 py-0.2 rounded-md bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-sm font-bold text-slate-200 border border-slate-700 flex items-center gap-1.5 transition cursor-pointer disabled:opacity-50"
                      >
                    ...
                    {isSearchGroundingLoading ? (
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-slate-800/60 p-3 rounded-xl border border-slate-700/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                          <div className="space-y-1">
                            <span className="text-xs uppercase font-bold text-slate-400 tracking-wider">LIVE SPOT ESTIMATE</span>
                            <div className="flex items-center gap-2">
                          ...
                          {(searchGrounding as any).cpcbEprStatus && (
                            <div className="text-left sm:text-right">
                              <span className="text-xs uppercase font-bold text-slate-400 tracking-wider">CPCB MANDATE</span>
                              <p className="text-sm text-accent-cyan/80 font-bold max-w-xs">{(searchGrounding as any).cpcbEprStatus}</p>
                            </div>
                          )}
                        </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                              {(searchGrounding as any).regionalPrices.map((hub, idx) => (
                                <div key={idx} className="bg-slate-800/80 p-2 rounded-xl border border-slate-700 text-center">
                                  <span className="text-xs text-slate-400 font-bold block truncate">{hub.hub}</span>
                                  <span className="text-sm font-extrabold text-accent-cyan/80 font-mono mt-0.5 block">
                        ...
                        {(searchGrounding as any).sources && (searchGrounding as any).sources.length > 0 && (
                          <div className="pt-2 border-t border-slate-800">
                            <span className="text-xs uppercase font-bold text-slate-400 block mb-1.5 flex items-center gap-1">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {(searchGrounding as any).sources.map((src, i) => (
                                <a
                                  ...
                                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-accent-cyan/80 hover:text-blue-200 text-sm font-medium border border-slate-700 transition"
                                >
                      ...
                      <div className="text-center py-3">
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-accent-cyan text-primary hover:bg-accent-cyan/80 text-white font-bold text-sm inline-flex items-center gap-1.5 transition cursor-pointer"
                        >
                ...
                {createdPassport ? (
                  <div className="bg-[#00E676]/10 p-4 rounded-2xl border border-[#00E676]/30 flex flex-col sm:flex-row items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-[#00E676] hover:bg-[#00C853] text-[#0B0F13] font-bold text-sm cursor-pointer shadow-xs whitespace-nowrap border border-[#00C853]"
                    >
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-2xl bg-[#00E676] hover:bg-[#00C853] text-[#0B0F13] font-extrabold text-sm transition cursor-pointer flex items-center justify-center gap-2 shadow-lg shadow-[#00E676]/25 border border-[#00C853]"
                  >
