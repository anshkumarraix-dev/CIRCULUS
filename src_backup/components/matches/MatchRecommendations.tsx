    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-3xl overflow-hidden border border-[#00E676]/30 bg-gradient-to-r from-[#12181F] via-[#1E2630] to-[#0B0F13] text-white p-6 sm:p-10 shadow-lg">
        ...
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00E676]/10 backdrop-blur-md border border-[#00E676]/30 text-xs font-semibold tracking-wide text-[#00E676]">
                  ...
                  >
                    ...
                    <div className="relative h-48 sm:h-56 w-full overflow-hidden bg-slate-900">
                      ...
                      <div className="absolute top-4 left-4 flex items-center gap-2">
                        <span className="px-3.5 py-1.5 rounded-xl bg-[#00E676] text-[#0B0F13] font-extrabold text-xs flex items-center gap-1.5 shadow-md shadow-[#00E676]/30 border border-[#00C853]">
                      ...
                      <div className="absolute top-4 right-4 hidden sm:flex items-center gap-2">
                        <div className="px-3.5 py-1.5 rounded-xl bg-[#1E2630]/80 backdrop-blur-md text-[#00E676] border border-[#00E676]/30 text-xs font-semibold flex items-center gap-1.5 shadow-md">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between gap-4">
                        ...
                        <button
                          ...
                          className="hidden md:flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#1E2630]/80 hover:bg-[#1E2630] backdrop-blur-md text-white text-xs font-bold border border-slate-600 transition cursor-pointer shrink-0"
                        >
                    ...
                    <div className="p-6 sm:p-8 space-y-6">
                      ...
                      {listing && (
                        <div className="bg-[#1E2630] p-4 rounded-2xl border border-slate-700 flex flex-wrap items-center justify-between gap-4 text-xs">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-extrabold text-white text-sm">{listing.title}</p>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="text-right">
                              ...
                              <p className="font-mono font-extrabold text-[#00E676] text-sm">
                                ₹{match.estimatedFreightInr.toLocaleString("en-IN")}
                              </p>
                            </div>
                            <button
                              onClick={() => onViewPassport(listing.passportId)}
                              className="px-3.5 py-2 rounded-xl bg-[#12181F] hover:bg-slate-800 border border-slate-600 text-slate-300 hover:text-white font-bold text-[11px] cursor-pointer shadow-2xs transition-colors"
                            >
                              Digital Aadhaar →
                            </button>
                          </div>
                      ...
                      <div className="p-4 rounded-2xl bg-gradient-to-r from-[#1E2630] via-[#12181F] to-[#1E2630] border border-slate-700 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
                        ...
                        <div className="text-[11px] text-slate-400 font-semibold flex items-center gap-1.5 shrink-0">
                      ...
                      <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-slate-800">
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                          <button
                            onClick={() => handleOpenInquiryModal(match)}
                            className="px-4 py-2.5 rounded-2xl bg-[#1E2630] hover:bg-slate-700 text-slate-300 hover:text-white font-bold text-[11px] transition cursor-pointer border border-slate-600"
                          >
                            Simulate Price & Lorry
                          </button>

                          {isSent ? (
                            <div className="bg-[#00E676]/10 px-5 py-2.5 rounded-2xl border border-[#00E676]/30 text-xs font-bold text-[#00E676] flex items-center gap-1.5">
                            ...
                            <button
                              ...
                              className="px-5 py-2.5 rounded-2xl bg-[#FF6D00] hover:bg-[#E65C00] text-white font-extrabold text-xs transition cursor-pointer flex items-center justify-center gap-2 shadow-sm shadow-[#FF6D00]/20"
                            >
            ...
            <div className="space-y-6">
              <div className="bg-[#12181F] p-8 sm:p-12 rounded-3xl border border-slate-700 text-center space-y-5 shadow-xs">
                ...
                <div className="max-w-md mx-auto space-y-1.5">
                  <h3 className="text-lg font-extrabold text-white">No Active Batch Matches Right Now</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 opacity-40 select-none pointer-events-none">
                <div className="bg-[#12181F] rounded-3xl border border-dashed border-slate-700 p-6 space-y-3">
                  ...
                  <h4 className="font-bold text-sm text-slate-300">Gujarat Secondary Extrusions Pvt Ltd</h4>
                ...
                <div className="bg-[#12181F] rounded-3xl border border-dashed border-slate-700 p-6 space-y-3">
                  ...
                  <h4 className="font-bold text-sm text-slate-300">Mahavir Eco-Polymers Reclaiming</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
              <div className="relative flex-1 w-full">
                ...
                <input
                  ...
                  className="w-full bg-[#1E2630] border border-slate-600 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-slate-400 focus:border-[#00E676] focus:bg-[#1E2630]/80 focus:outline-none font-medium"
                />
              </div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <select
                  ...
                  className="bg-[#1E2630] border border-slate-600 rounded-xl px-3 py-2.5 text-xs text-slate-300 focus:border-[#00E676] font-semibold cursor-pointer outline-none"
                >
              ...
              >
                ...
                <div className="relative h-44 w-full overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="px-3 py-1 rounded-xl bg-[#1E2630]/85 backdrop-blur-md text-[#00E676] text-[11px] font-bold border border-[#00E676]/30 flex items-center gap-1 shadow-md">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-center gap-3">
                    ...
                    <div className="truncate">
                      ...
                      <p className="text-[#00E676] text-xs truncate">📍 {buyer.city}, {buyer.state}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 space-y-4 flex-1 flex flex-col justify-between">
                  <div className="space-y-2.5 text-xs">
                    <div>
                      <span className="text-[10px] text-slate-500 uppercase font-bold">Plant Operations:</span>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-[#1E2630] hover:bg-slate-700 border border-slate-600 text-white font-bold text-xs transition cursor-pointer flex items-center justify-center gap-1.5"
                  >
        ...
        <div className="fixed inset-0 z-50 bg-[#0B0F13]/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto overscroll-contain" data-lenis-prevent="true">
          <div className="bg-[#12181F] rounded-3xl border border-slate-700 max-w-xl w-full p-6 sm:p-8 space-y-5 shadow-2xl relative my-8 animate-fadeIn">
            ...
            <div className="flex items-start justify-between pb-3 border-b border-slate-800">
              <div>
                <span className="text-[10px] uppercase font-bold px-2.5 py-0.5 rounded-lg bg-[#00E676]/10 text-[#00E676] border border-[#00E676]/30">
              ...
              <button
                ...
                className="text-slate-500 hover:text-white p-1.5 rounded-xl hover:bg-slate-800 cursor-pointer text-xs transition"
              >
                ✕ Close
              </button>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-[#1E2630] border border-[#00E676]/30 flex items-center gap-3 text-xs">
            ...
            <form onSubmit={handleConfirmInquiryDispatch} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#1E2630] border border-slate-700 rounded-xl px-3 py-2 text-slate-400 text-xs font-medium opacity-70"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#1E2630] border border-slate-700 rounded-xl px-3 py-2 text-white text-xs focus:border-[#00E676] focus:bg-[#1E2630]/80 focus:outline-none font-medium"
                />
              </div>

              <div className="bg-[#1E2630] p-3.5 rounded-2xl border border-slate-700 flex items-center justify-between text-xs">
                <div>
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-2xl bg-[#00E676] hover:bg-[#00C853] text-[#0B0F13] font-extrabold text-xs transition cursor-pointer flex items-center justify-center gap-2 shadow-sm shadow-[#00E676]/20 border border-[#00C853]"
              >
                {inquirySuccess ? (
                  <>
