      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl space-y-6">
            ...
            <p className="text-base sm:text-lg text-silver/80 font-body max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex min-w-max items-center gap-6">
              {BENCHMARK_TICKERS.map((t, idx) => (
                ...
                >
                  ...
                  <span
                    className={`font-mono text-[10px] font-bold ${t.trend.startsWith("+") ? "text-accent-gold" : "text-rose-400"}`}
                  >
                    {t.trend}
                  </span>
                </button>
        ...
        <div className="flex justify-end mb-4">
          {introDismissed && (
            <button
              ...
              className="text-[10px] text-silver hover:text-accent-gold flex items-center gap-1 font-body"
            >
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 max-w-[200px]">
                          ...
                          <p className="text-[10px] text-silver truncate mt-0.5">
                            {listing.grade}
                          </p>
                        </td>
                        <td className="px-4 py-3">
            ...
            <div className="bg-panel p-6 sm:p-8 rounded-3xl border border-white/10 space-y-6 shadow-xs">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/5">
                <div className="space-y-1">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-accent-gold/10 text-accent-gold text-xs font-extrabold border border-accent-gold/20">
                ...
                <button
                  onClick={onOpenRealTimeEntryModal}
                  className="px-5 py-3 rounded-2xl bg-accent-gold hover:bg-accent-gold/80 text-ink font-extrabold text-xs transition cursor-pointer flex items-center gap-2 shadow-sm shrink-0"
                >
                ...
                {QUICK_SAMPLE_BATCHES.map((batch) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <h4 className="font-extrabold text-ink text-xs leading-snug group-hover:text-accent-gold transition">
                          {batch.title}
                        </h4>
                      ...
                      <div className="pt-2 border-t border-white/10 flex items-center justify-between text-xs">
                        <div>
                          <span className="text-[10px] text-silver/60 uppercase font-bold">
                            Value:
                          </span>
                          <p className="font-mono font-extrabold text-accent-gold text-xs">
                            {formatInrCurrency(
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/5 bg-gradient-to-r from-slate-900 via-slate-800 to-emerald-950 text-ink p-6 sm:p-8 shadow-lg space-y-6">
              ...
              <div className="relative z-10 space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-white/15">
                  <div>
                    <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent-gold/20 backdrop-blur-md text-emerald-300 border border-emerald-400/30 text-xs font-bold mb-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="bg-panel/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 flex flex-col justify-between space-y-2">
                    <div>
                      <span className="text-[11px] text-ink/80 font-bold uppercase">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 px-4 rounded-xl bg-accent-gold hover:bg-emerald-400 text-slate-950 font-extrabold text-xs transition cursor-pointer flex items-center justify-center gap-2 shadow-md"
                    >
                      <Zap className="w-4 h-4" />
            ...
            <div className="bg-panel p-6 sm:p-8 rounded-3xl border border-white/10 space-y-4 shadow-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                <div className="bg-white/5 p-4 rounded-2xl border border-white/10 space-y-2">
                  ...
                  <h5 className="font-extrabold text-ink text-sm">
