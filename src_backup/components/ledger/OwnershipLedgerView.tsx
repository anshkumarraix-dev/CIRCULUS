      ...
      <div className="bg-[#12181F] p-5 rounded-3xl border border-slate-700 space-y-3 shadow-xs">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-accent-cyan text-primary hover:bg-accent-cyan/80 text-xs font-extrabold text-white transition cursor-pointer flex items-center justify-center gap-1.5 shadow-xs"
          >
            ...
            {passports.length > 0 ? (
              <form onSubmit={handleTransfer} className="space-y-3 text-xs">
                ...
                <button
                  ...
                  className="w-full py-3 rounded-2xl bg-accent-cyan text-primary hover:bg-accent-cyan/80 text-white font-extrabold text-xs transition cursor-pointer flex items-center justify-center gap-2 shadow-sm shadow-accent-cyan/20"
                >
                  {isSubmitting ? (
                    <>
