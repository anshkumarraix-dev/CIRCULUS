        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-primary border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-ink focus:border-accent-cyan focus:bg-primary/50 focus:outline-none font-semibold"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-primary border border-white/10 rounded-lg px-3 py-2 text-xs text-ink focus:border-accent-cyan focus:bg-primary/50 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-primary border border-white/10 rounded-lg px-3 py-2 text-xs text-ink focus:border-accent-cyan focus:bg-primary/50 focus:outline-none font-mono"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-primary border border-white/10 rounded-lg px-3 py-2 text-xs text-ink focus:border-accent-cyan focus:bg-primary/50 focus:outline-none font-mono font-bold"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-primary border border-white/10 rounded-lg px-3 py-2 text-xs text-accent-cyan focus:border-accent-cyan focus:bg-primary/50 focus:outline-none font-mono font-bold"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-primary border border-white/10 rounded-lg px-3 py-2 text-xs text-ink focus:border-accent-cyan focus:bg-primary/50 focus:outline-none font-medium"
              >
          ...
          <div className="bg-slate-800 p-4 rounded-2xl border border-slate-700 grid grid-cols-2 gap-4 text-xs font-mono">
            <div>
              ...
              <p className="text-lg font-bold text-accent-cyan mt-0.5">{formatInrCurrency(totalValueInr, true)}</p>
            </div>
            <div>
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-accent-cyan text-primary hover:bg-accent-cyan/80 text-ink font-bold text-xs uppercase tracking-tight transition flex items-center justify-center gap-2 cursor-pointer shadow-md shadow-accent-cyan/20"
          >
            {isSubmitting ? (
