      ...
      <div className="relative rounded-3xl overflow-hidden p-6 sm:p-8 border border-[#00E676]/30 bg-gradient-to-r from-[#00E676]/10 via-[#12181F] to-[#1E2630] text-white shadow-md">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="max-w-2xl space-y-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-[#00E676]/20 text-[#00E676] border border-[#00E676]/30 text-xs font-bold">
          ...
          <button
            ...
            className="px-5 py-3 rounded-2xl bg-[#00E676] hover:bg-[#00C853] text-[#0B0F13] font-extrabold text-xs flex items-center gap-2 transition cursor-pointer shadow-md shadow-[#00E676]/20 shrink-0 border border-[#00C853]"
          >
      ...
      <div className="bg-[#12181F] p-5 rounded-3xl border border-slate-700 flex flex-col sm:flex-row gap-3 items-center justify-between shadow-xs">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <select
            ...
            className="bg-[#1E2630] border border-slate-600 rounded-xl px-3 py-2.5 text-xs text-slate-300 focus:border-[#00E676] focus:bg-[#1E2630]/80 focus:outline-none cursor-pointer font-semibold"
          >
      ...
      {filtered.length > 0 ? (
            ...
            >
              ...
              <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#1E2630]">
                ...
                <div className="absolute top-3 left-3 flex items-center gap-1.5">
                  <span className="px-2.5 py-1 rounded-xl bg-[#12181F]/95 backdrop-blur-md text-slate-300 font-mono text-[10px] font-bold border border-slate-700 shadow-xs">
                    {passport.id}
                  </span>
                  <span className="px-2.5 py-1 rounded-xl bg-[#00E676]/20 backdrop-blur-md text-[#00E676] text-[10px] font-bold border border-[#00E676]/30 shadow-xs flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3" />
                    Verified
                  </span>
                </div>

                <div className="absolute bottom-3 right-3 bg-[#00E676] text-[#0B0F13] px-2.5 py-1 rounded-xl text-xs font-extrabold shadow-md">
              ...
              <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                <div>
                  <p className="text-[10px] text-slate-400 font-bold uppercase truncate">{passport.ownerOrg}</p>
                  <h3 className="text-base font-extrabold text-white group-hover:text-[#00E676] transition mt-0.5 leading-snug tracking-tight">
                    {passport.title}
                  </h3>
                ...
                {/* Stats Box */}
                <div className="bg-[#1E2630] p-3.5 rounded-2xl border border-slate-700 space-y-1.5 text-xs">
                ...
                {/* View Button */}
                <div className="pt-1 flex items-center justify-between text-xs font-bold text-slate-300 group-hover:text-[#00E676] transition-colors">
        ...
        <div className="space-y-6">
          <div className="bg-[#12181F] p-8 sm:p-12 rounded-3xl border border-slate-700 text-center space-y-4 shadow-xs">
            ...
            <p className="text-base font-extrabold text-white">No Digital Scrap Aadhaar Cards Found</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 opacity-40 select-none pointer-events-none">
            <div className="bg-[#12181F] rounded-3xl border border-dashed border-slate-600 p-5 space-y-3">
              ...
              <p className="font-bold text-xs text-slate-400">Sample: Clean Extrusion Aluminium Scrap</p>
              <div className="flex justify-between text-[11px] text-slate-500 pt-2 border-t border-slate-700">
            ...
            <div className="bg-[#12181F] rounded-3xl border border-dashed border-slate-600 p-5 space-y-3">
              ...
              <p className="font-bold text-xs text-slate-400">Sample: Washed Industrial Bottle Flakes</p>
              <div className="flex justify-between text-[11px] text-slate-500 pt-2 border-t border-slate-700">
            ...
            <div className="bg-[#12181F] rounded-3xl border border-dashed border-slate-600 p-5 space-y-3">
              ...
              <p className="font-bold text-xs text-slate-400">Sample: HMS 1 & 2 Structural Steel</p>
              <div className="flex justify-between text-[11px] text-slate-500 pt-2 border-t border-slate-700">
